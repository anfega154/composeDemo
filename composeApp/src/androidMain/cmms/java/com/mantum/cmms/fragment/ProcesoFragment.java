...
public class ProcesoFragment extends Mantum.Fragment {

    public final static String KEY_TAB = "Proceso";

    private TimeLineAdapter<Proceso> timeLineAdapter;
    ...
    public String getTitle(@NonNull Context context) {
        return context.getString(R.string.tab_proceso);
    }
    ...
    public void onRefresh(@NonNull List<Proceso> values) {
        timeLineAdapter.clear();
    ...
    public void showMessageEmpty() {
        ...
        message.setText(getView().getContext().getString(R.string.procesos_mensaje_vacio));
    }
}