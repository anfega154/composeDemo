...
public class ConsumiblesAsociadosListaFragment extends Mantum.Fragment {

    public final static String KEY_TAB = "Consumibles_Asociados";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        alphabetAdapter.showMessageEmpty(view, R.string.consumibles_mensaje_vacio);
    ...
    public String getTitle(@NonNull Context context) {
        return context.getString(R.string.tab_consumibles_asociados_ot);
    }
    ...
    public void onLoad(@NonNull List<Consumible> values) {
        ...
        if (getView() != null) {
            alphabetAdapter.showMessageEmpty(getView(), R.string.consumibles_mensaje_vacio);
        }
    }
}
