...
public class CustomAlphabetAdapter<T extends ViewAdapter<T>> extends Mantum.Adapter<T, CustomAlphabetAdapter.ViewHolder> {
    ...
    public CustomAlphabetAdapter(@NonNull Context context) {
        super(context);
        this.summary = true;
    ...
    public CustomAlphabetAdapter(@NonNull Context context, boolean showletter) {
        super(context);
        this.summary = true;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.custom_alphabet_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final CustomAlphabetAdapter.ViewHolder holder, int position) {
