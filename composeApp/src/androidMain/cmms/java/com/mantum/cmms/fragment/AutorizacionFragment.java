...
public class AutorizacionFragment extends Mantum.Fragment {

    public final static String KEY_TAB = "Autorizacion";
    ...
    public String getTitle(@NonNull Context context) {
        return context.getString(R.string.autorizaciones);
    }
