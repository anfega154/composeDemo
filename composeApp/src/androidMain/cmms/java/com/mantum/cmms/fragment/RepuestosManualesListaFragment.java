...
public class RepuestosManualesListaFragment extends Mantum.Fragment {

    public final static String KEY_TAB = "Respuestos_Manuales";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        alphabetAdapter.showMessageEmpty(view, R.string.repuestos_manuales_mensaje_vacio);
    ...
    public String getTitle(@NonNull Context context) {
        return context.getString(R.string.tab_repuestos_manuales);
    }
    ...
    public void onLoad(@NonNull List<RepuestoManual> values) {
        ...
        if (getView() != null) {
            alphabetAdapter.showMessageEmpty(getView(), R.string.repuestos_manuales_mensaje_vacio);
        }
    }
}
