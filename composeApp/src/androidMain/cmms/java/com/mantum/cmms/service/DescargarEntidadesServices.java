...
public class DescargarEntidadesServices extends MicroServices {

    private final Database database;

    private final Gson gson = new Gson();

    public DescargarEntidadesServices(@NonNull Context context, @NonNull Cuenta cuenta) {
    ...
    public Observable<Response> get() {
        return Observable.create(subscriber -> {
            ...
            String url = cuenta.getServidor().getUrl() + "/restapp/app/obtenerentidades";
