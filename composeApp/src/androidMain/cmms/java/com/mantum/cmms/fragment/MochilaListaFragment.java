...
public class MochilaListaFragment extends Mantum.Fragment {

    public final static String KEY_TAB = "Mochila";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        alphabetAdapter.showMessageEmpty(view, R.string.bitacora_resources_empty_mochila);
        return view;
    }
    ...
    public String getTitle(@NonNull Context context) {
        return context.getString(R.string.tab_mochila);
    }

    public void onLoad(@NonNull List<Mochila> values) {
        alphabetAdapter.addAll(values);
        if (getView() != null) {
            alphabetAdapter.showMessageEmpty(getView(), R.string.bitacora_resources_empty_mochila);
        }
    }
}