...
public class ClienteServices extends Service {

    private final String version;

    public ClienteServices(@NonNull Context context, Cuenta cuenta) {
        super(context);
    ...
    public Observable<Response> get(String query) {
        return Observable.create(subscriber -> {
            ...
            String url = Preferences.url(context, "restapp/app/filtercliente?filter="+query);
                ...
                public void onResponse(@NonNull Call call, @NonNull okhttp3.Response response)
                    ...
                    try {
                        if (response.isSuccessful()) {
                            ...
                            subscriber.onError(new Exception(context.getString(R.string.error_request_autocomplete_cliente)));
                        }
                    } catch (Exception e) {
                        subscriber.onError(e);
                    }
