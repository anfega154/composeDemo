...
public class AlmacenAdapter<T extends ViewTrasladoAdapter<T>> extends Mantum.Adapter<T, AlmacenAdapter.ViewHolder> {
    ...
    public AlmacenAdapter(@NonNull Context context) {
        super(context);
        this.summary = true;
    ...
    public AlmacenAdapter(@NonNull Context context, boolean showletter) {
        super(context);
        this.summary = true;
    ...
    @NonNull
    @Override
    public AlmacenAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.alphabet_layout_detail, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final AlmacenAdapter.ViewHolder holder, int position) {
        ...
        if (showletter) {
            ...
            if (holder.getAdapterPosition() < total) {
                ...
                ViewTrasladoAdapter before = getItemPosition(holder.getAdapterPosition() - 1);
        ...
        holder.aditional1.setText("");
        if (adapter.getNombeBodega() != null) {
            holder.aditional1.setText(adapter.getNombeBodega());
        }

        holder.aditional2.setText("");
        if (adapter.getEstadoItem() != null) {
            holder.aditional2.setText(adapter.getEstadoItem());
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        final TextView aditional1;
        final TextView aditional2;
        ...
        public ViewHolder(View itemView) {
            ...
            aditional1 = itemView.findViewById(R.id.aditional1);
            aditional2 = itemView.findViewById(R.id.aditional2);
